...
std::string zipString(const std::string &string1, const std::string &string2) {
    std::vector<std::string> stringList1 = split(string1);
    std::vector<std::string> stringList2 = split(string2);
